                    ...
                    <aside class="widget">
                        ...
                        <div class="pbmit-contact-widget-lines">
                            <a href="https://maps.app.goo.gl/4r1P4qqp36AEcAce8">
                                <div class="pbmit-contact-widget-line pbmit-base-icon-location">Office No. 505, ABH
                                    Samruddhi, Near Dream Castle Signal, Makhamalabad Road, Nashik – 422003,
                                    Maharashtra, India</div>
                            </a>
                            <div class="pbmit-contact-widget-line pbmit-base-icon-phone"><a href="tel:+918686313133">+91
                                    8686 313 133</a></div>
                            <div class="pbmit-contact-widget-line pbmit-base-icon-phone"><a href="tel:+917447777070">+91
                                    7447 777 070</a></div>
                            <div class="pbmit-contact-widget-line pbmit-base-icon-phone"><a href="tel:+918889303303">+91
                                    8889 303 303</a></div>
                            <div class="pbmit-contact-widget-line pbmit-base-icon-email"><a
                                    href="mailto:info@shivanjalirenewables.com">info@shivanjalirenewables.com</a></div>
                            <div class="pbmit-contact-widget-line">Working Hours: Monday – Saturday, 9:00 AM – 6:00 PM
                            </div>
                        </div>
                    </aside>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="pbmit-footer-copyright-text-area"> Copyright © <?php echo date('Y'); ?> <a
                                href="./">Shivanjali Renewables</a>, All Rights Reserved.</div>
                    </div>
                    <div class="col-md-6">
