...
<head>
    ...
    <title>Shivanjali Renewables</title>
                ...
                <div class="container-fluid">
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="pbmit-pre-header-right">
                            <ul class="pbmit-contact-info">
                                <li>
                                    <a href="mailto:info@shivanjalirenewables.com">
                                        <i class="pbmit-base-icon-email"></i> info@shivanjalirenewables.com
                                    </a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="tel:+918686313133">
                                        <i class="pbmit-base-icon-phone-call-1"></i> +91 8686313133
                                    </a>
                                </li>
                            </ul>
                        </div>
                            ...
                            <div class="pbmit-header-content d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="site-branding">
                                            <h1 class="site-title">
                                                <a href="./" class="pbmit-logo-link">
                                                    <img class="logo-img" src="images/Shivanjali_Logo.jpg"
                                ...
                                <div class="pbmit-right-box d-flex align-items-center">
                                    ...
                                    <div class="pbmit-header-phone">
                                        <a href="tel:+918686313133" class="pbmit-header-phone-link"
