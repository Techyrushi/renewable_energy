...
<head>
	...
	<meta property="og:site_name"
		content="<?php echo htmlspecialchars($sr_company_name !== '' ? $sr_company_name : 'Shivanjali Renewables', ENT_QUOTES, 'UTF-8'); ?>">
	...
	<script
		type="application/ld+json"><?php echo json_encode($sr_schema, JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE); ?></script>
	<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
	<base
		href="<?php echo htmlspecialchars(($sr_base_path !== '' ? $sr_base_path : '') . '/', ENT_QUOTES, 'UTF-8'); ?>">
	<!-- Favicon -->
	<link rel="shortcut icon" type="image/x-icon"
		href="<?php echo htmlspecialchars($sr_site_favicon, ENT_QUOTES, 'UTF-8'); ?>">
	<!-- CSS
		 ============================================ -->
	<!-- Bootstrap CSS -->
					...
					<div class="d-flex justify-content-between">
						<div class="pbmit-pre-header-left">
							<ul class="pbmit-contact-info">
								<li class="text-primary"><i class="pbmit-base-icon-headphones"></i> Looking for the
									right solar solution?<a class="text-primary" href="contact"> Get a free quote</a></li>
							</ul>
						</div>
							...
							<ul class="pbmit-contact-info">
								<li class="text-primary">
									<a class="text-primary"
										href="mailto:<?php echo htmlspecialchars($sr_company_email, ENT_QUOTES, 'UTF-8'); ?>">
										<i class="pbmit-base-icon-email"></i>
										<?php echo htmlspecialchars($sr_company_email, ENT_QUOTES, 'UTF-8'); ?>
									</a>
								</li>
								<li class="text-primary">
									<a class="text-primary"
										href="<?php echo htmlspecialchars($sr_company_map_url, ENT_QUOTES, 'UTF-8'); ?>">
										<i
											class=" pbmit-base-icon-marker"></i><?php echo htmlspecialchars($sr_company_map_label, ENT_QUOTES, 'UTF-8'); ?>
									</a>
								</li>
								<li class="text-primary">
									<a class="text-primary"
										href="tel:<?php echo htmlspecialchars($sr_company_phone_tel, ENT_QUOTES, 'UTF-8'); ?>">
										<i class="pbmit-base-icon-phone-call-1"></i>
										<?php echo htmlspecialchars($sr_company_phone, ENT_QUOTES, 'UTF-8'); ?>
									</a>
								</li>
							</ul>
						</div>
								...
								<div class="pbmit-right-box d-flex align-items-center">
									...
									<div class="pbmit-header-phone">
										<a href="tel:<?php echo htmlspecialchars($sr_company_phone_tel, ENT_QUOTES, 'UTF-8'); ?>"
											class="pbmit-header-phone-link" aria-label="Call Shivanjali Renewables">
											<i class="pbmit-base-icon-phone-call-1"></i>
										</a>
									</div>
