...
<!-- Mirrored from admin.pixelstrap.net/admiro/accordion.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Feb 2026 10:58:37 GMT -->
        ...
        <div class="main-sidebar" id="main-sidebar">
          <ul class="sidebar-menu" id="simple-bar">
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
              ...
              <ul class="sidebar-submenu">
                <li><a class="submenu-title" href="javascript:void(0)">form-control<i class="iconly-Arrow-Right-2 icli">
                    </i></a>
                  <ul class="according-submenu">
                ...
                <li><a class="submenu-title" href="javascript:void(0)">Form Widgets<i class="iconly-Arrow-Right-2 icli">
                    </i></a>
                  <ul class="according-submenu">
                ...
                <li><a class="submenu-title" href="javascript:void(0)">Form Layout<i class="iconly-Arrow-Right-2 icli">
                    </i></a>
                  <ul class="according-submenu">
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
              ...
              <ul class="sidebar-submenu">
                ...
                <li><a class="submenu-title" href="javascript:void(0)">Data Tables<i class="iconly-Arrow-Right-2 icli">
                    </i></a>
                  <ul class="according-submenu">
            ...
            <li class="sidebar-list"> <i class="fa-solid fa-thumbtack"></i><a class="sidebar-link"
              ...
              <ul class="sidebar-submenu">
                <li><a class="submenu-title" href="javascript:void(0)">Error Page<i class="iconly-Arrow-Right-2 icli">
                    </i></a>
                  <ul class="according-submenu">
                ...
                <li><a class="submenu-title" href="javascript:void(0)">Coming Soon<i class="iconly-Arrow-Right-2 icli">
                    </i></a>
                  <ul class="according-submenu">
        ...
        <div class="container-fluid">
          <div class="page-title">
            <div class="row">
              ...
              <div class="col-sm-6 col-12">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"> <a href="index-2.html"> <i class="iconly-Home icli svg-color"></i></a>
                  </li>
            ...
            <div class="col-sm-12 col-xl-6">
              <div class="card">
                <div class="card-header card-no-border pb-0">
                  ...
                  <p class="mt-1 mb-0 mb-0">Using the <code>.accordion   </code>class to expand/collapse to accordion
                    content.</p>
                ...
                <div class="card-body">
                  <div class="accordion dark-accordion" id="simpleaccordion">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="headingOne">
                        <button class="accordion-button collapsed accordion-light-primary text-primary active"
                          type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true"
                          aria-controls="collapseOne">What do web designers do?<i
                      ...
                      <div class="accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                          <p>Web design<em class="text-danger"> identifies the goals</em> of a website or webpage and
                            promotes accessibility for all potential users. This process involves organizing content and
                            images across a series of pages and integrating applications and other interactive elements.
                          </p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item accordion-wrapper">
                      <h2 class="accordion-header" id="headingTwo">
                        <button class="accordion-button collapsed accordion-light-primary text-primary" type="button"
                          data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false"
                          aria-controls="left-collapseTwo">What is the use of web design? <i
                            class="iconly-Arrow-Down-2 icli ms-auto icon"></i></button>
                      </h2>
                      <div class="accordion-collapse collapse" id="collapseTwo" aria-labelledby="headingTwo"
                        data-bs-parent="#simpleaccordion">
                        <div class="accordion-body">
                          <p class="mb-3"><strong> Search engine optimization: </strong> Search engine optimization
                            (SEO) is a method for improving the chances for a website to be found by search engines. Web
                            design codes information in a way that search engines can read it. It can boost business
                            because the site shows up on the top search result pages, helping people to find it.</p>
                          <p class="mb-3"> <strong> Mobile responsiveness:</strong> Mobile responsiveness is the feature
                            of a website that allows it to display on a mobile device and adapt its layout and
                            proportions to be legible. Web design ensures sites are easy to view and navigate from
                            mobile devices. When a website is well-designed and mobile-responsive, customers can reach
                            the business with ease.</p>
                          <p class="mb-3"><strong> Improved sales:</strong>Increasing the number of items sold or
                            acquiring more active customers are objectives of a compelling website. As web design
                            reaches targeted customers and search engines, it helps the business make conversions on
                            their site and improve its sales.</p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item accordion-wrapper">
                      <h2 class="accordion-header" id="headingThree">
                        <button class="accordion-button collapsed accordion-light-primary text-primary" type="button"
                          ...
                          aria-controls="left-collapseThree">What are the elements of web design?<i
                            class="iconly-Arrow-Down-2 icli ms-auto icon"> </i></button>
                      </h2>
                      <div class="accordion-collapse collapse" id="collapseThree" aria-labelledby="headingThree"
                        data-bs-parent="#simpleaccordion">
                        <div class="accordion-body">
                          <p>The web design process allows designers to adjust to any preferences and provide effective
                  ...
                  <div class="code-box-copy">
                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#simple-according"
                      title="Copy"><i class="fa-regular fa-copy"></i></button>
            ...
            <div class="col-sm-12 col-xl-6">
              <div class="card">
                <div class="card-header card-no-border pb-0">
                  ...
                  <p class="mt-1 mb-0">Add <code>.accordion-flush</code> to remove the default background-color, border,
                    etc.</p>
                  <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                      <li><i class="fa-solid fa-ellipsis"></i></li>
                  ...
                  <div class="accordion accordion-flush dark-accordion" id="accordionFlushExample">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="flush-headingOne">
                        <button class="accordion-button collapsed text-success accordion-light-success active"
                          ...
                          aria-expanded="false" aria-controls="flush-collapseOne">What is bootstrap?</button>
                      </h2>
                      <div class="accordion-collapse collapse show" id="flush-collapseOne"
                        ...
                        <div class="accordion-body">
                          <ul class="d-flex flex-column gap-1 accordions-content">
                            <li>--> Bootstrap is the most popular HTML, CSS and JavaScript framework for developing a
                              responsive and mobile friendly website.</li>
                    ...
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="flush-headingTwo">
                        <button class="accordion-button collapsed text-success accordion-light-success" type="button"
                      ...
                      <div class="accordion-collapse collapse" id="flush-collapseTwo" aria-labelledby="flush-headingTwo"
                        ...
                        <div class="accordion-body">
                          <ul class="d-flex flex-column gap-2 accordions-content">
                            <li>First and foremost, Bootstrap is easy to learn. Due to its popularity, plenty of
                              tutorials and online forums are available to help you get started.</li>
                            <li>One of the reasons why Bootstrap is so popular among web developers and web designers is
                              that it has a simple file structure. Its files are compiled for easy access, and it only
                              requires basic knowledge of HTML, CSS, and JS to modify them.</li>
                            <li>You can also use themes for popular content management systems as learning tools. For
                              example, most WordPress themes were developed using Bootstrap, which any beginner web
                              developer can access. </li>
                            <li>To increase the site's page load time, Bootstrap minifies the CSS and JavaScript files.
                              Additionally, Bootstrap maintains consistency across the syntax between websites and
                              developers, which is ideal for team-based projects.</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      ...
                      <div class="accordion-collapse collapse" id="flush-collapseThree"
                        ...
                        <div class="accordion-body">
                          <ul class="d-flex flex-column gap-2 accordions-content">
                            <li>Bootstrap handles the image display and responsiveness with its predefined HTML and CSS
                              rules.</li>
                            <li>Adding the .img-responsive class will automatically resize images based on the users'
                              screen size. This will benefit your website’s performance, as reducing image sizes is part
                              of the site optimization process.</li>
                            <li>Bootstrap also provides additional classes like .img-circle and .img-rounded, which help
                              to modify the images' shape.</li>
                          </ul>
                        </div>
                      </div>
                    </div>
            ...
            <div class="col-sm-12">
              <div class="card">
                <div class="card-header card-no-border pb-0">
                  ...
                  <p class="mt-1 mb-0">Use <code> href </code> on <code>data-bs-toggle attribute</code> to show and hide
                    multiple elements.</p>
                  <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                      <li><i class="fa-solid fa-ellipsis"></i></li>
                ...
                <div class="card-body">
                  <div class="common-flex"><a class="btn btn-primary" data-bs-toggle="collapse"
                    ...
                    <button class="btn btn-warning text-white" type="button" data-bs-toggle="collapse"
                  ...
                  <div class="row d-flex">
                    <div class="col-xl-6">
                      <div class="collapse multi-collapse" id="multiCollapseExample1">
                        <div class="card card-body mt-3 mb-0 collapse-wrapper accordion-light-primary"><span>The
                            collapse JavaScript plugin is used to show and hide content. Buttons or anchors are used as
                            triggers that are mapped to specific elements you toggle. Collapsing an element will animate
                            the height from it's current value to 0. Given how CSS handles animations, you cannot use
                            padding on a .collapse element. Instead, use the class as an independent wrapping
                            element.</span></div>
                      </div>
                    </div>
                    <div class="col-xl-6">
                      <div class="collapse multi-collapse" id="multiCollapseExample2">
                        <div class="card card-body mt-3 mb-0 collapse-wrapper accordion-light-warning"><span>This is the
                            first item's accordion body. It is shown by default, until the collapse plugin adds the
                            ...
                            this with custom CSS or overriding our default variables.</span></div>
                      </div>
                    </div>
                  </div>
                  <div class="code-box-copy">
                  ...
                  <div class="accordion" id="accordionPanelsStayOpenExample">
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                        <button class="accordion-button collapsed gap-2 accordion-light-secondary active text-secondary"
                          type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne"
                          aria-expanded="false" aria-controls="panelsStayOpen-collapseOne"><i
                            class="fa-regular fa-bell"> </i>Keep in touch <i
                            class="iconly-Arrow-Down-2 icli ms-auto icon"></i></button>
                      </h2>
                      <div class="accordion-collapse collapse" id="panelsStayOpen-collapseOne"
                        aria-labelledby="panelsStayOpen-headingOne">
                        <div class="accordion-body">
                          <p> <em class="text-danger"> " This page might not behave as expected because Windows Internet
                              Explorer isn't configured to load unsigned ActiveX controls."</em> or "Allow this page to
                            install an unsigned ActiveX Control? Doing so from untrusted sources may harm your
                            computer." (Both phrased as conditions that may cause future problems.)</p>
                        </div>
                      </div>
                    </div>
                    <div class="accordion-item">
                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                        <button class="accordion-button collapsed gap-2 accordion-light-secondary active text-secondary"
                          ...
                          aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo"><i
                            class="fa-regular fa-comment"> </i>Chats with others<i
                            class="iconly-Arrow-Down-2 icli ms-auto icon"></i></button>
                      </h2>
                        ...
                        <div class="accordion-body">
                          <ul class="d-flex flex-column gap-2 accordions-content">
                            <li>You get the same features in Chat and Chat in Gmail, but the integrated Gmail experience
                              provides a central location to communicate with friends, family, or coworkers between
                              emails.</li>
                            <li> <strong> Chat: </strong> Use when you prefer a dedicated chat experience and don't mind
                      ...
                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                        <button class="accordion-button collapsed gap-2 accordion-light-secondary active text-secondary"
                          ...
                          aria-expanded="false" aria-controls="panelsStayOpen-collapseThree"><i
                            class="fa-regular fa-square-check"></i>Right way to code <i
                            class="iconly-Arrow-Down-2 icli ms-auto icon"></i></button>
                      </h2>
            ...
            <div class="col-xl-6 col-sm-12">
              <div class="card">
                ...
                <div class="card-body">
                  <div class="accordion dark-accordion" id="outlineaccordion">
                    <div class="accordion-item accordion-wrapper accordion-left-border">
                      <h2 class="accordion-header" id="outlineaccordionone">
                        <button class="accordion-button collapsed accordion-light-primary text-primary" type="button"
                          ...
                          aria-controls="left-collapseOne">What do web designers do?<i
                            class="iconly-Arrow-Down-2 icli ms-auto icon"></i></button>
                      </h2>
                    ...
                    <div class="accordion-item accordion-wrapper accordion-left-border">
                      ...
                      <div class="accordion-collapse collapse" id="left-collapseTwo"
                        ...
                        <div class="accordion-body">
                          <ul class="d-flex flex-column gap-2 accordions-content">
                            <li><strong> Search engine optimization: </strong> Search engine optimization (SEO) is a
                              method for improving the chances for a website to be found by search engines. Web design
                              codes information in a way that search engines can read it. It can boost business because
                              the site shows up on the top search result pages, helping people to find it.</li>
                            <li> <strong> Mobile responsiveness:</strong> Mobile responsiveness is the feature of a
                              website that allows it to display on a mobile device and adapt its layout and proportions
                              to be legible. Web design ensures sites are easy to view and navigate from mobile devices.
                              When a website is well-designed and mobile-responsive, customers can reach the business
                              with ease.</li>
                            <li> <strong> Improved sales:</strong>Increasing the number of items sold or acquiring more
                              active customers are objectives of a compelling website. As web design reaches targeted
                              customers and search engines, it helps the business make conversions on their site and
                    ...
                    <div class="accordion-item accordion-wrapper accordion-left-border">
                      ...
                      <div class="accordion-collapse collapse" id="left-collapseThree"
                        ...
                        <div class="accordion-body">
                          <ul class="d-flex flex-column gap-2 accordions-content">
                            <li>The web design process allows designers to adjust to any preferences and provide
                              effective solutions. There are many standard components of every web design, including:
                            </li>
                            <li>--> Layout</li>
                            <li>--> Images</li>
                            <li>--> Visual hierarchy</li>
                  ...
                  <div class="code-box-copy">
                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#outline-according"
                      title="Copy"><i class="fa-regular fa-copy"></i></button>
            ...
            <div class="col-xl-6 col-sm-12">
              <div class="card">
                <div class="card-header card-no-border pb-0">
                  ...
                  <p class="mt-1 mb-0">
                    Add the <code>.collapse-horizontal</code> modifier class to transition the width instead of height
                    and set a width on the immediate child element.</p>
                  <div class="card-header-right">
                    <ul class="list-unstyled card-option">
                      <li><i class="fa-solid fa-ellipsis"></i></li>
                      <li><i class="fa-solid fa-code view-html"></i></li>
                  ...
                  <div class="row">
                    <div class="col-xl-6 col-9">
                      <div class="collapse collapse-horizontal mt-3" id="collapseWidthExample">
                        <div class="card card-body bg-secondary-light accordion-h-space mb-0"><span>The collapse plugin
                            also supports horizontal collapsing. Add the .collapse-horizontal modifier class to
                            transition the width instead of height and set a width on the immediate child element. Feel
                            free to write your own custom Sass, use inline styles, or use our width utilities.</span>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div class="col-xl-6 col-sm-12">
              <div class="card">
                <div class="card-header card-no-border pb-0">
                  ...
                  <p class="mt-1 mb-0">
                    Use a link with the href attribute <code>(and a role="button"). </code>In both cases, the
                ...
                <div class="card-body">
                  <p class="mb-2 common-flex"><a class="btn btn-info" data-bs-toggle="collapse" href="#collapseExample"
                  ...
                  <div class="collapse" id="collapseExample">
                    <div class="card card-body border mb-0">Some placeholder content for the collapse component. This
                      panel is hidden by default but revealed when the user activates the relevant trigger.</div>
                  </div>
                  <div class="code-box-copy">
                    <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#tag-according"
                      title="Copy"><i class="fa-regular fa-copy"></i></button>
