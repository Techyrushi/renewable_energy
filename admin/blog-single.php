...
<!-- Mirrored from admin.pixelstrap.net/admiro/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Feb 2026 10:59:53 GMT -->
                ...
                <div class="card-body">
                  <div class="blog-single">
                    <div class="blog-box blog-details"> <img class="img-fluid w-100"
                        src="./assets/images/blog/blog-single.jpg" alt="blog-main">
                      <div class="blog-details">
                        <ul class="blog-social">
                          <li>25 July 2018</li>
                          <li><i class="fa-solid fa-user"></i>Mark<span>Jecno</span></li>
                          <li><i class="fa-solid fa-thumbs-up"></i>02<span>Hits</span></li>
                          <li><i class="fa-solid fa-comments"></i>598 Comments</li>
                        </ul>
                        <h4>
                    ...
                    <section class="comment-box">
                      ...
                      <ul>
                              ...
                              <div class="row">
                                ...
                                <div class="col-md-8">
                                  <ul class="comment-social float-start float-md-end">
                                    <li> <i class="fa-solid fa-thumbs-up"></i>02 Hits</li>
                                    <li><i class="fa-solid fa-comments"></i>598 Comments</li>
                                  </ul>
                                </div>
                              </div>
                        ...
                        <li>
                          <div class="d-flex"><img class="align-self-center" src="./assets/images/blog/4.jpg"
                              alt="Generic placeholder image">
                            <div class="flex-grow-1">
                              <div class="row">
                                <div class="col-md-4">
                        ...
                        <li>
                          <div class="d-flex"><img class="align-self-center" src="./assets/images/blog/12.png"
                              alt="Generic placeholder image">
                            <div class="flex-grow-1">
                              <div class="row">
                                <div class="col-md-4">
                        ...
                        <li>
                          <div class="d-flex"><img class="align-self-center" src="./assets/images/blog/14.png"
                              alt="Generic placeholder image">
                            <div class="flex-grow-1">
                              <div class="row">
                                <div class="col-md-4">
...
<!-- Mirrored from admin.pixelstrap.net/admiro/blog-single.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Feb 2026 10:59:54 GMT -->
