...
<!-- Mirrored from admin.pixelstrap.net/admiro-email.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Feb 2026 10:59:47 GMT -->
...
<head>
  ...
  <meta name="description"
    content="Admiro admin is super flexible, powerful, clean &amp; modern responsive bootstrap 4 admin template with unlimited possibilities.">
  <meta name="keywords"
      ...
      <tr>
        <td>
            ...
            <tbody>
              <tr class="header">
                <td align="left" valign="top"><img class="main-logo for-light"
                    src="./assets/images/logo/logo-dark.png"></td>
                <td class="menu" align="right" style="padding-right:15px;">
                  <ul>
                    <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">Home</a></li>
                    <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">Whishlist</a>
                    </li>
                    <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">My cart</a>
                    </li>
                    <li style="display: inline-block;text-decoration: unset"><a href="javascript:void(0)">Contact</a>
                    </li>
                  </ul>
                </td>
              </tr>
          ...
          <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
            <tbody>
              <tr>
                <td><img class="img-fluid" src="./assets/images/email-template/1.jpg" alt="" style="width: 100%;"></td>
              </tr>
            </tbody>
          </table>
              ...
              <tr>
                <td>
                  <div class="product-box hover">
                    <div class="product border-theme"><img class="img-fluid" src="./assets/images/email-template/2.png"
                        alt="product"></div>
                    <div class="product-info">
                      <div class="rating" style="margin-bottom:5px;"><i class="fa-solid fa-star"
                          style="color:#e6c830;"></i><i class="fa-solid fa-star" style="color:#e6c830;"></i><i
                          class="fa-solid fa-star" style="color:#e6c830;"></i><i class="fa-solid fa-star"
                          style="color:#e6c830;"></i><i class="fa-solid fa-star" style="color:#e6c830;"></i></div><a
                ...
                <td>
                  <div class="product-box hover">
                    <div class="product border-theme"><img class="img-fluid" src="./assets/images/email-template/7.png"
                        alt="product"></div>
                    <div class="product-info">
                      <div class="rating" style="margin-bottom:5px;"><i class="fa-solid fa-star"
                          style="color:#e6c830;"><i class="fa-solid fa-star" style="color:#e6c830;"></i><i
                            class="fa-solid fa-star" style="color:#e6c830;"></i><i class="fa-solid fa-star"
                            style="color:#e6c830;"></i><i class="fa-solid fa-star" style="color:#e6c830;"></i></i></div>
          ...
          <table class="main-bg-light" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:40px;">
            <tbody>
              ...
              <tr class="add-with-banner" align="center">
                <td><img class="img-fluid" style="border-radius:10px;" src="./assets/images/email-template/3.png"></td>
                <td>
                  <div style="border-top:1px solid #2e8e87; mso-line-height-rule: exactly;"
                    ...
                    <div class="Heading" align="center"
                      ...
                      data-color="Week Heading" data-size="Week Heading" data-min="15" data-max="43">This Week&apos;s
                      Sale </div>
                    <div class="Heading" align="center"
                      ...
                      data-color="Week Heading" data-size="Week Heading" data-min="15" data-max="45">Save Up To 50%
                    </div>
                  </a>
                  <div style="border-bottom:1px solid #2e8e87; mso-line-height-rule: exactly;"
            ...
            <tbody>
              <tr align="center">
                <td><a href="javascript:void(0)"><img class="img-fluid"
                      src="./assets/images/email-template/cosmetic.jpg" style="width:100%;"></a></td>
              </tr>
            </tbody>
          </table>
          <table class="product-banner" border="0" cellpadding="0" cellspacing="0" width="100%"
            ...
            <tbody>
              <tr class="add-with-banner" align="center">
                <td><a href="javascript:void(0)"><img class="img-fluid" src="./assets/images/email-template/6.png"
                      style="border-radius:10px;"></a></td>
                <td><a href="javascript:void(0)"><img class="img-fluid" src="./assets/images/email-template/5.png"
                      style="border-radius:10px;"></a></td>
              </tr>
            </tbody>
          </table>
                    ...
                    <tbody>
                      <tr>
                        <td><a href="javascript:void(0)"
                            style="color: #2e8e87;font-size:14px;text-transform: capitalize;font-weight:600;">Want to
                            change how you receive these emails?</a></td>
                      </tr>
                      <tr>
                        <td>
                          <p style="font-size:14px; margin:8px 0; color:#717171;">2024 - 23 Copy Right by Themeforest
                            powerd by Pixel Strap</p>
                        </td>
                      </tr>
                      <tr>
                        <td><a href="javascript:void(0)"
                            style="color: #2e8e87;font-size: 14px;text-transform: capitalize;font-weight:600; margin:0;">Unsubscribe</a>
                        </td>
                      </tr>
                    </tbody>
                  </table>
...
<!-- Mirrored from admin.pixelstrap.net/admiro-email.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 04 Feb 2026 10:59:48 GMT -->
